...
public class Ustawienia extends Activity {
    ...
    public static String jednostkaOpadow() {
        return jednostkiOpady;
    }

    public static String jednostkaWiatru() {
        return jednostkiWiatr;
    }

    public static String jednostkaTemperatury() {
        return jednostkiTemperatura;
    }

    public static String jednostkaCisnienia() {
        return jednostkiCisnienie;
    }

    public static boolean wyswietlicTemp() {
        return temp;
    }

    public static boolean wyswietlicTempOdczuwalna() {
        return tempOdczuwalna;
    }

    public static boolean wyswietlicOpadyIntensywnosc() {
        return opadyIntensywnosc;
    }

    public static boolean wyswietlicOpadySzansa() {
        return opadySzansa;
    }

    public static boolean wyswietlicWilgotnosc() {
        return wilgotnosc;
    }

    public static boolean wyswietlicWiatrSr() {
        return wiatrSr;
    }

    public static boolean wyswietlicWiatrWPorywach() {
        return wiatrWPorywach;
    }

    public static boolean wyswietlicWiatrKierunek() {
        return wiatrKierunek;
    }

    public static boolean wyswietlicCisnienie() {
        return cisnienie;
    }

    public static boolean wyswietlicZachmurzenie() {
        return zachmurzenie;
    }
